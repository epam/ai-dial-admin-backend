...
public class ScaleCallImpl implements ScaleCall {
    private final FunctionInfo function;
    private final List<Expression> args;

    public ScaleCallImpl(FunctionInfo function, List<Expression> args) {
        this.function = function;
        this.args = args;
    }

    public ScaleCallImpl(FunctionInfo function, Expression... args) {
        this.function = function;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ScaleCallImpl)) return false;

        ScaleCallImpl that = (ScaleCallImpl) o;
