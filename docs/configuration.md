...
| config.version.autoDetect.schedule.delayMs        | CORE_CONFIG_VERSION_AUTO_DETECT_SCHEDULE_DELAY_MILLISECONDS   | 300000              | Interval in milliseconds between calls to the /version endpoint on core                                                                                                  |
