...
| config.version.autoDetect.enabled        | ENABLE_CORE_VERSION_AUTO_DETECT          | false                | Enable auto-detection of Core version                                                                                                       |
| config.version.autoDetect.period         | CORE_VERSION_AUTO_DETECT_RETRY_PERIOD_MS    | 10000                | Retry delay in milliseconds for Core version auto-detection                                                                                 |
| config.version.autoDetect.maxAttempts    | CORE_VERSION_AUTO_DETECT_RETRY_MAX_ATTEMPTS    | 3                    | Maximum number of retry attempts for Core version auto-detection                                                                            |
