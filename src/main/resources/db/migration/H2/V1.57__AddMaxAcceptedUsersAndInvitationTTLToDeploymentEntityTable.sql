alter table if exists role_share_resource_limit_entity alter column invitation_ttl bigint;
alter table if exists role_share_resource_limit_entity_aud alter column invitation_ttl bigint;
