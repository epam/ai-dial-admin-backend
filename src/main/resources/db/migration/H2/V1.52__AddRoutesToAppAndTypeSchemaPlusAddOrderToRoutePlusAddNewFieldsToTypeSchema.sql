...
alter table if exists application_entity add column if not exists routes clob;
alter table if exists application_entity_aud add column if not exists routes clob;
...
alter table if exists application_type_schema_entity add column if not exists routes clob;
...
alter table if exists application_type_schema_entity_aud add column if not exists routes clob;
