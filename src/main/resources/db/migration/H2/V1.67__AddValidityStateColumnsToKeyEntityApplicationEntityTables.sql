...
alter table if exists key_entity alter column validity_state_is_valid boolean not null;
...
alter table if exists application_entity alter column validity_state_is_valid boolean not null;
