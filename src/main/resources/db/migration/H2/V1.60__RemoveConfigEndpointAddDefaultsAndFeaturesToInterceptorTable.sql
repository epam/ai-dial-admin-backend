...
alter table if exists interceptor_entity add column if not exists defaults clob;
...
alter table if exists interceptor_entity_aud add column if not exists defaults clob;
