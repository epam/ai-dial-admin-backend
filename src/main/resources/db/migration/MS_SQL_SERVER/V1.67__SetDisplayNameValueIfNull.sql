...
alter table application_entity alter column display_name nvarchar(max) not null;
...
alter table model_entity alter column display_name nvarchar(max) not null;
