...
UPDATE application_type_schema_entity SET append_application_properties_header = 1 WHERE append_application_properties_header IS NULL;
...
ALTER TABLE application_type_schema_entity ALTER COLUMN append_application_properties_header BIT NOT NULL;

-- Update application_type_schema_entity_aud
UPDATE application_type_schema_entity_aud SET append_application_properties_header = 1 WHERE append_application_properties_header IS NULL AND revtype != 2;


-- Update model_entity
UPDATE model_entity SET max_retry_attempts = 1 WHERE max_retry_attempts IS NULL OR max_retry_attempts <= 0;
ALTER TABLE model_entity ADD CONSTRAINT df_model_entity_max_retry_attempts DEFAULT 1 FOR max_retry_attempts;
ALTER TABLE model_entity ALTER COLUMN max_retry_attempts INT NOT NULL;
...
ALTER TABLE application_entity ADD CONSTRAINT df_application_entity_max_retry_attempts DEFAULT 1 FOR max_retry_attempts;
ALTER TABLE application_entity ALTER COLUMN max_retry_attempts INT NOT NULL;
...
ALTER TABLE route_entity ADD CONSTRAINT df_route_entity_max_retry_attempts DEFAULT 1 FOR max_retry_attempts;
ALTER TABLE route_entity ALTER COLUMN max_retry_attempts INT NOT NULL;
...
ALTER TABLE tool_set_entity ADD CONSTRAINT df_tool_set_entity_max_retry_attempts DEFAULT 1 FOR max_retry_attempts;
ALTER TABLE tool_set_entity ALTER COLUMN max_retry_attempts INT NOT NULL;
