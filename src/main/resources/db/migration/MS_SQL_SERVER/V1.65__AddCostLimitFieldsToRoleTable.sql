...
alter table role_entity add cost_limit_minute numeric(38,18);
...
go
alter table role_entity alter column cost_limit_minute numeric(38,18) not null;

alter table role_entity add cost_limit_day numeric(38,18);
...
go
alter table role_entity alter column cost_limit_day numeric(38,18) not null;

alter table role_entity add cost_limit_week numeric(38,18);
...
go
alter table role_entity alter column cost_limit_week numeric(38,18) not null;

alter table role_entity add cost_limit_month numeric(38,18);
...
go
alter table role_entity alter column cost_limit_month numeric(38,18) not null;

-- add cost limit's fields to role_entity_aud
alter table role_entity_aud add cost_limit_minute numeric(38,18);
alter table role_entity_aud add cost_limit_day numeric(38,18);
alter table role_entity_aud add cost_limit_week numeric(38,18);
alter table role_entity_aud add cost_limit_month numeric(38,18);
go
