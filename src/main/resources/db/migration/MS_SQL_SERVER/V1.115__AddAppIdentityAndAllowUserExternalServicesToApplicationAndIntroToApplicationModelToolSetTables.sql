...
alter table application_entity add app_identity nvarchar(max);
...
alter table application_entity_aud add app_identity nvarchar(max);
...
alter table application_entity add intro nvarchar(max);
alter table application_entity_aud add intro nvarchar(max);

-- add intro field to model tables
alter table model_entity add intro nvarchar(max);
alter table model_entity_aud add intro nvarchar(max);

-- add intro field to tool_set tables
alter table tool_set_entity add intro nvarchar(max);
alter table tool_set_entity_aud add intro nvarchar(max);
