...
alter table application_entity add app_identity nvarchar(255);
...
alter table application_entity_aud add app_identity nvarchar(255);
...
alter table application_entity add intro nvarchar(255);
alter table application_entity_aud add intro nvarchar(255);

-- add intro field to model tables
alter table model_entity add intro nvarchar(255);
alter table model_entity_aud add intro nvarchar(255);

-- add intro field to tool_set tables
alter table tool_set_entity add intro nvarchar(255);
alter table tool_set_entity_aud add intro nvarchar(255);
