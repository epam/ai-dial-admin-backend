...
update adapter_entity set display_name = name where display_name is null;
update adapter_entity_aud set display_name = name where display_name is null and revtype != 2;
...
update addon_entity set display_name = deployment_name where display_name is null;
update addon_entity_aud set display_name = deployment_name where display_name is null and revtype != 2;
...
update application_entity set display_name = deployment_name where display_name is null;
update application_entity_aud set display_name = deployment_name where display_name is null and revtype != 2;
...
update application_type_schema_entity set application_type_display_name = schema_id where application_type_display_name is null;
update application_type_schema_entity_aud set application_type_display_name = schema_id  where application_type_display_name is null and revtype != 2;
...
update assistant_entity set display_name = deployment_name where display_name is null;
update assistant_entity_aud set display_name = deployment_name where display_name is null and revtype != 2;
...
update interceptor_entity set display_name = name where display_name is null;
update interceptor_entity_aud set display_name = name where display_name is null and revtype != 2;
...
update interceptor_runner_entity set display_name = name where display_name is null;
update interceptor_runner_entity_aud set display_name = name where display_name is null and revtype != 2;
...
update key_entity set display_name = name where display_name is null;
update key_entity_aud set display_name = name where display_name is null and revtype != 2;
...
update model_entity set display_name = deployment_name where display_name is null;
update model_entity_aud set display_name = deployment_name where display_name is null and revtype != 2;
...
update role_entity set display_name = name where display_name is null;
update role_entity_aud set display_name = name where display_name is null and revtype != 2;
...
update route_entity set display_name = deployment_name where display_name is null;
update route_entity_aud set display_name = deployment_name where display_name is null and revtype != 2;
...
update tool_set_entity set display_name = deployment_name where display_name is null;
update tool_set_entity_aud set display_name = deployment_name where display_name is null and revtype != 2;
