...
alter table if exists model_entity add column if not exists endpoint text;
...
alter table if exists model_entity_aud add column if not exists endpoint text;
