...
alter table if exists application_entity add column if not exists reasoning_efforts_supported boolean;

-- add reasoningEffortsSupported field to application_entity_aud table
alter table if exists application_entity_aud add column if not exists reasoning_efforts_supported boolean;

-- add reasoningEffortsSupported field to model_entity table
alter table if exists model_entity add column if not exists reasoning_efforts_supported boolean;

-- add reasoningEffortsSupported field to model_entity_aud table
alter table if exists model_entity_aud add column if not exists reasoning_efforts_supported boolean;

-- add reasoningEffortsSupported field to assistants_property_entity table;
alter table if exists assistants_property_entity add column if not exists reasoning_efforts_supported boolean;

-- add reasoningEffortsSupported field to assistants_property_entity_aud table
alter table if exists assistants_property_entity_aud add column if not exists reasoning_efforts_supported boolean;

-- add reasoningEffortsSupported field to interceptor_entity table
alter table if exists interceptor_entity add column if not exists reasoning_efforts_supported boolean;

-- add reasoningEffortsSupported field to interceptor_entity_aud table
alter table if exists interceptor_entity_aud add column if not exists reasoning_efforts_supported boolean;