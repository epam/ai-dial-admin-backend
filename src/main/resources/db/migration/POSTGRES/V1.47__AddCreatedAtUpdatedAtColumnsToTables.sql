...
alter table if exists key_entity rename column created_at_ms to created_at;
alter table if exists key_entity add column if not exists updated_at bigint;

-- add new fields to key_entity_aud table
alter table if exists key_entity_aud rename column created_at_ms to created_at;
alter table if exists key_entity_aud add column if not exists updated_at bigint;