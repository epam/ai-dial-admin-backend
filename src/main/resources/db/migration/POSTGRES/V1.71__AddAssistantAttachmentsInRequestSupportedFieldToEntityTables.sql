...
update application_entity set assistant_attachments_in_request_supported = false where assistant_attachments_in_request_supported is null and revtype != 2;
...
update model_entity set assistants_property_entity = false where assistant_attachments_in_request_supported is null;
...
update model_entity set interceptor_entity = false where assistant_attachments_in_request_supported is null;
