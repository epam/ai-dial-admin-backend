...
public abstract class AbstractQueryEngine implements Engine {

    protected final DatasetDeclaration declaration;

    protected AbstractQueryEngine(DatasetDeclaration declaration) {
    ...
    private Table getTable(TableDeclaration tableDeclaration) {
