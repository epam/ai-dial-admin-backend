...
public class ConfigImporter {
    ...
    public ImportConfigPreview importPreview(Config config, ConfigImportOptions importOptions) {
        ...
        var models = modelImporter.importModels(config.getModels(), config.getCatalogSchemas(), importOptions);
        var addons = addonImporter.importAddons(config.getAddons(), importOptions);
        var applications = applicationImporter.importApplications(config.getApplications(), config.getApplicationTypeSchemas(), config.getCatalogSchemas(), importOptions);
        ...
        var toolSets = toolSetImporter.importToolSets(config.getToolsets(), config.getCatalogSchemas(), importOptions);
    ...
    public void importConfig(Config config, ConfigImportOptions importOptions) {
        ...
        try (var scope = auditParentActivityHolder.openScope(parentId)) {
            ...
            modelImporter.importModels(config.getModels(), config.getCatalogSchemas(), importOptions);
            addonImporter.importAddons(config.getAddons(), importOptions);
            applicationImporter.importApplications(config.getApplications(), config.getApplicationTypeSchemas(), config.getCatalogSchemas(), importOptions);
            ...
            toolSetImporter.importToolSets(config.getToolsets(), config.getCatalogSchemas(), importOptions);
