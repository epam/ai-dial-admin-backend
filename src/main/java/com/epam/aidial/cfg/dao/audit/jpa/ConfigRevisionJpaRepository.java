...
public interface ConfigRevisionJpaRepository extends CrudRepository<ConfigRevisionEntity, Integer>, PagingAndSortingRepository<ConfigRevisionEntity, Integer> {
